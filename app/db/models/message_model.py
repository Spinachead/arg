...
class MessageModel(Base):
    ...
    def __repr__(self):
        return f"<messages(id='{self.id}', threadId='{self.threadId}', chatType='{self.chatType}', query='{self.query}', response='{self.response}', metadata='{self.metadata_}', createdAt='{self.createdAt}')>"
