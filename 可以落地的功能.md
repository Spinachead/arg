...
### 查询拆解与分领域分支（Domain-specific decomposition）--- 已经简单实现查询转换
...
### 用户个性化与记忆（Memory/Personalization）---已实现长期记忆
...
### 前端要有一个地方支持上传文档
前端自定义一个地方可以配置和上传数据库文档

### 选择大模型的地方(已做)
前端要有选择大模型配置的地方 如配置选择哪个模型 配置api_key等等


**优化的地方**
- 项目初始化的时候没有知识库要引导用户新建知识库
