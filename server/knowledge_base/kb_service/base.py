...
class KBServiceFactory:
    ...
    def get_service(
        ...
        if SupportedVSType.FAISS == vector_store_type:
            ...
            from server.knowledge_base.kb_service.pg_kb_service import (
                PGKBService,
            )

            return PGKBService(**params)
        elif SupportedVSType.RELYT == vector_store_type:
            from server.knowledge_base.kb_service.relyt_kb_service import (
                RelytKBService,
            )
            ...
            from server.knowledge_base.kb_service.es_kb_service import (
                ESKBService,
            )
